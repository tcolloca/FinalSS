...
public class Main extends Application {
  ...
  public void paintSquare(int row, int col, Color color) {
    ...
    polyBurn.getPoints().addAll(new Double[] {0.0, 0.0, width, 0.0, width, height, 0.0, height,});
  ...
  public void burnPartially(int row, int col, Direction direction) {
    ...
    double width = SCREEN_W / W;
    double height = SCREEN_H / H;
    addPolygon(row, col, new Double[] {0.0, 0.0, width, 0.0, width, height / 2 * SIZE_ADJUSTMENT,
        width / 2 * SIZE_ADJUSTMENT, height, 0.0, height,}, angle, BURN_COLOR);
  }
